...
export default function P9() {
    ...
    return (
        <div className={style.listDiv}>
            <MoreInfo />
             <h3 className={style.linkWithLogo}><img src={reakcja} alt="" /><span> &gt; </span> szkoła <span> &gt; </span>rekomendacja rozwiązań</h3>
            ...
            <div className={style.nav}>
                ...
                {showButton &&
                    <Link to={getGameRoute(PAGES.p31)} className={style.buttonNext} onClick={addSelectedInputs}>
                        Dalej
                    </Link>
                }
            </div>
